          ...
          {historyData ? (
            <div className="w-full h-full rounded-xl flex flex-col">
              ...
              <div className="h-20 flex justify-center items-center gap-10 rounded-xl overflow-hidden">
                ...
                {selectedData && <div className="px-2 py-2 rounded-xl bg-green-100 border border-green-500 text-green-500 font-semibold">
                  forest area {selectedData["forest Area(%)"]}%
                </div>}
                {selectedData && <div className="px-2 py-2  rounded-xl bg-yellow-600/20 border border-yellow-600 text-yellow-600 font-semibold">
                  land area {selectedData["land_Area(%)"]}%
                </div>}
                <div
